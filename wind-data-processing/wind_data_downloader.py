    ...
    if isinstance(data, tuple) and len(data) == 2:
        ...
        if error_code == 0:
            ...
            output_file = DataPaths.DUPONT_DATA_DIR / \
                        f"{DownloadConfig.OUTPUT_FILE_PREFIXES['dupont']}_{year}.csv"
            ...
            try:
                ...
                result_df.to_csv(output_file, 
                               ...
                               index=True)
                print(f"dupont data saved to: {output_file}")
